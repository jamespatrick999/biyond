...
export class ReferralLink extends Component {
    ...
    render() {
        ...
        const headerStyle = { marginTop: "-18px", backgroundImage: "linear-gradient(to right, #131050, black)", borderRadius: "5px", color: "#2DE1EE", textAlign: "center", fontWeight: "bold", fontSize: "21px" }
                    ...
                    <div className="col-xl-6" style={colStyle}>
                        ...
                        <div className="col-xl-12" style={{ textAlign: "center" }}>
                            <form style={{ textAlign: "center" }}>
                                <input style={{ textAlign: "center", backgroundColor: "black", color: "#2DE1EE", width: "100%", height: "30px" }}
