...
export class ReferralLink extends Component {
    ...
    render() {
        ...
        const headerStyle = { marginTop: "-18px", backgroundImage: "linear-gradient(to right, #131050, black)", borderRadius: "5px", color: "#1AE865", textAlign: "center", fontWeight: "bold", fontSize: "21px" }
